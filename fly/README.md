...
gdown --folder 1qR_zcP7BKTIJcC13YLCgz6UTN9uFymwt -O ./songs --remaining-ok
gdown --folder 13mesb1mRJtp0CT2rPImzlmLhLTxWwgsO -O ./data --remaining-ok

./gdrive files download --recursive 
1AqwHnlynYz00N-1fwEH08h3LO_hvDsF6 Africa1
1DYQvmUVG0eFMT_ieodOPfgzxKUJsaVgF Africa2
1NEZv-6-_Tdpfjiw0R5C5yXKXox4HvWPy Africa3
1ghOoBtxqpuQlk3LFAyONuEVCcnsGbj9H Africa4
1wtVVJxEuQZGWH0oWW-b2KSmvwaClryRs Africa5
1YAUarN7YYZ4UX2r9L7bVI0oFSRpovhzD Nigeria1
1v9ynbWAnJJ9tKnKxWPwv-NtoGKozT_13 Nigeria2
...
```
du -h --max-depth=1 /home/pythonuser | sort -hr | head -n 20
find home/pythonuser/project/vocals/ -type f | wc -l
...
## Training commands
python3 audioldm_train/infer.py --config_yaml audioldm_train/config/2023_08_23_reproduce_audioldm/audioldm_original.yaml --list_inference tests/captionlist/inference_test.lst --reload_from_ckpt /home/pythonuser/project/musicgen/AudioLDM-training-finetuning/log/latent_diffusion/2023_08_23_reproduce_audioldm/audioldm_original/checkpoints


!python musicgen-dreamboothing/dreambooth_musicgen.py \
    --use_lora \
    --model_name_or_path "facebook/musicgen-melody" \
    --dataset_name "ogbanugot/musicgen" \
    --dataset_config_name "default" \
    --target_audio_column_name "audio" \
    --instance_prompt "afrobeats" \
    --train_split_name "train" \
    --eval_split_name "train" \
    --output_dir "./musicgen-melody-lora-afrobeats-with-vocals-long" \
    --do_train \
    --fp16 \
    --num_train_epochs 50 \
